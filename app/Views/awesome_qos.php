						...
						<div class="col-md-12 mb-5 mb-md-0">
							...
							<div class="card h-100">
								...
								<header class="card-header d-flex align-items-center justify-content-between">
									<h2 class="h4 card-header-title">QoS Data</h2>
												...
												<td class="py-3">
													<div class="media align-items-center">
														...
														<div class="media-body">
															...
															<small class="text-muted"> <?php echo timeAgo($row["time"]); ?></small>
														</div>
													</div>
												</td>
								...
								<footer class="card-footer border-0">
									<a class="font-weight-semi-bold" href="<?php echo site_url("/dashboard/qos_summary");?>">View Summary</a>
								</footer>
								<!-- End Card Footer -->
							</div>
							<!-- End Active Tasks -->
