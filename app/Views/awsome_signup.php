							...
							<div class="card-body p-4 p-lg-7">
								...
								<form action="<?php echo site_url(); ?>/Register/store" method="post">
									...
									<div class="form-group">
										...
										<input id="dname" name="dname" class="form-control" type="text" placeholder="Your full name">
									</div>
									<!-- End Full Name -->
									...
									<div class="form-group">
										...
										<input id="confirm_password" name="confirm_password" class="form-control" type="password" placeholder="Enter your password again">
									</div>
									...
									<p class="text-center mb-0">
										...
										<a class="font-weight-semi-bold" href="<?php echo site_url(); ?>/Login/signin">Login here</a>
									</p>
								</form>
								<!-- End Sign in Form -->
							</div>
