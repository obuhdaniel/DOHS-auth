(function ($) {
  $(document).on('ready', function () {
    ...
    var chart,
      chartClass = '.js-workflow-chart',
      data = {
        labels: ['Wor', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep'],
        datasets: [{
          data: [12,000, 9200, 10800, 10400, 12800, 13200, 15200, 14800, 15600],
          ...
          data: [1000, 900, 900, 700, 700, 900, 1000, 1000, 1000],
